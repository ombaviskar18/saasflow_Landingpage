...
const Footer = () => {
    return (
        <footer className="flex flex-col relative items-center justify-center border-t border-border pt-16 pb-8 px-6 lg:px-8 w-full max-w-6xl mx-auto lg:pt-32">
                    ...
                    <div className="md:grid md:grid-cols-2 md:gap-8">
                        ...
                        <div className="mt-10 md:mt-0 flex flex-col">
                            ...
                            <ul className="mt-4 text-sm text-muted-foreground">
                                ...
                                <li className="mt-2">
                                    <Link href="https://www.linkedin.com/in/om-baviskar-/" className="hover:text-foreground transition-all duration-300">
                                        LinkedIn
                                    </Link>
                                </li>
                            </ul>
            ...
            <div className="mt-8 border-t border-border/40 pt-4 md:pt-8 md:flex md:items-center md:justify-between ">
