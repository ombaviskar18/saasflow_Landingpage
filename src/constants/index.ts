...
export const perks = [
    {
        ...
        info: "Quickly sign up and start building your workflow tools effortlessly.",
    },
    {
        icon: Icons.customize,
        title: "Effortless Customization",
        info: "Tailor templates and features to align perfectly with your workflow needs.",
    },
    {
        icon: Icons.launch,
        title: "Streamlined Deployment",
        info: "Launch your tools smoothly and enhance your team's efficiency instantly.",
    },
];
